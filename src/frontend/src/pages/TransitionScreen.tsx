...
export default function TransitionScreen() {
  ...
  useEffect(() => {
    ...
    // Use the shared speakWithBestVoice utility that handles async voice loading
    speakWithBestVoice(greetingText, {
      rate: 0.9,
      pitch: 0.78,
      volume: 1,
    });
    ...
    <div className="min-h-screen bg-jarvis-bg flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 font-mono text-sm w-full max-w-lg px-8 mb-8">
        {displayedLines.map((line) => (
          <div key={line} className="text-jarvis-cyan/70 mb-1">
